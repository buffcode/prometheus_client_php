...
class CollectorRegistry
{
     ...
     * @throws MetricsRegistrationException
     */
    public function registerSummary($namespace, $name, $help, $labels = array(), $quantiles = null)
    {
        $metricIdentifier = self::metricIdentifier($namespace, $name);
     ...
     * @return Summary
     */
    public function getOrRegisterSummary($namespace, $name, $help, $labels = array(), $quantiles = null)
    {
        try {
